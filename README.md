...
| 样式定制 | 15 块背景板分三组（渐变 / 纯色 / 深色，含透明底：导出 PNG 保留 alpha、JPG 自动垫白）与自定义渐变、画布圆角、设备阴影、整体缩放、每台设备 X / Y / 宽度 / 旋转 |
...
![导出样例：四设备 2x 排版图（模板「经典全家福」+ 背景板「落日熔金」）](docs/images/export-sample.jpg)
